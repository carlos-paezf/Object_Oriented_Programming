...
const config: Config = {
    ...
    themeConfig: {
        ...
        footer: {
            ...
            copyright: `Copyright © ${ new Date().getFullYear() }. @carlos-paezf. Built with Docusaurus.`,
        },
        prism: {
        ...
        // Improve SEO
        metadata: [
            { name: 'keywords', content: 'object oriented programming, academic, explanation, university, algorithms, computer science, java, javascript, python, typescript, documentation' },
